...
def start_collecting(keyword, page_num):
    hitpoint = kijiji_head + keyword+"/page-" + str(page_num) + kijiji_tail
    print(f"Hitting on {hitpoint}")
...
# Just call this function from outside the class to start searching for the info
